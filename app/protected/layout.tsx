...
export default function ProtectedLayout({
  ...
  return (
    <div className="bg-muted/30 flex min-h-screen justify-center">
      <div className="bg-background relative flex min-h-screen w-full max-w-[390px] flex-col shadow-xl">
